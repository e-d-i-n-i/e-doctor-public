...
import { fetchAnsweredFollowUpQuestionsByUsername } from "@/api/fetch-followUp-questions"; // Adjust the import path
...
export function DataTable() {
  ...
  const fetchData = async (isManualRefresh: boolean = false) => {
    try {
      ...
      const questions = await fetchAnsweredFollowUpQuestionsByUsername(
        username
      );
      setData(questions);
