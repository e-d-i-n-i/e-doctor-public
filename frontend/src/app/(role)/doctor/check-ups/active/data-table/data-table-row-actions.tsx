...
import { BadgeInfo, BotMessageSquare, MoreHorizontal } from "lucide-react";
        ...
        <DropdownMenuContent align="end" className="w-[160px] z-50">
          <DropdownMenuItem className="group flex w-full items-center justify-between text-left p-0 text-sm font-base text-neutral-500 ">
            <Button
              ...
              asChild
            >
              <Link href={`/doctor/diagnosis/chat/${diagnosiId}`}>
                <BotMessageSquare className="h-4 w-4 text-blue-600" />{" "}
                <span className="text-sm font-normal"> Open Discussion </span>
              </Link>
            </Button>
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          ...
          <DropdownMenuItem className="group flex w-full items-center justify-between text-left p-0 text-sm font-base text-neutral-500 ">
            <Button
              ...
              asChild
            >
              <Link href={`/doctor/check-ups/active/preview/${diagnosiId}`}>
