...
import { CardDetails } from "@/components/card-patient-instance-details";
      ...
      <PrivateRoute requiredRole="doctor">
        <div className="flex flex-col h-screen">
          <div className="container mx-auto py-10 pl-3">
            <PageHeader
              title="Patient Instance Details"
          ...
          <div className="flex-1 mt-2">
            <CardDetails
              route={`api/PatientContextByDiagnosisId2/${id}`}
              backUrl="/doctor/check-ups/active"
            />
          </div>
        </div>
      </PrivateRoute>
