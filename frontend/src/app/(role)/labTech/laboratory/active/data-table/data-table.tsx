...
import { fetchPendingLaboratoryTestRequests } from "@/api/fetch-laboratory-requests"; // Adjust the import path
...
export function DataTable() {
  ...
  const fetchData = async (isManualRefresh: boolean = false) => {
    try {
      const requests = await fetchPendingLaboratoryTestRequests();
      setData(requests);
