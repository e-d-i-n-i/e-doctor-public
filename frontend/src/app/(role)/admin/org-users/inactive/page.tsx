      ...
      <PrivateRoute requiredRole="admin">
        <div>
          <div className="container mx-auto py-10 pl-3">
            <PageHeader
              title="Inactive Organization Users"
              description="This page displays inactive organization users in a detailed table. You can search for specific users and perform various actions to manage them efficiently."
            />
          </div>
