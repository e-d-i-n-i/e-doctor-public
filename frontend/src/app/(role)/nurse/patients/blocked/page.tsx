        ...
        <div>
          <div className="container mx-auto py-10 pl-3">
            <PageHeader
              ...
              description="This page displays blocked patient in a detailed table. You can search for specific patient and perform various actions to manage them efficiently."
            />
          </div>
