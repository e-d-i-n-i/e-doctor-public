...
// Define the form schema with validation for addresses
...
export async function updateAddress(
  ...
  const response = await fetch(
    process.env.NEXT_PUBLIC_CHANGE_ADDRESS_ENDPOINT!,
    {
      method: "POST",
      headers: {
  ...
  if (!response.ok) {
    ...
    throw new Error(errorDetails.error || "Failed to update address.");
  }
