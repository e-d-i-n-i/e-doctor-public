...
// Define the form schema with validation for email
...
export async function updateEmail(
  ...
  const response = await fetch(process.env.NEXT_PUBLIC_CHANGE_EMAIL_ENDPOINT!, {
    method: "POST",
    headers: {
  ...
  if (!response.ok) {
    ...
    throw new Error(errorDetails.error || "Failed to update email.");
  }
