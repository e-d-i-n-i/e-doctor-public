...
const formSchema = z.object({
  userid: z.string(),
  new_salary: z.string().min(1, "Salary must be at least 1 character long"),
  current_password: z
    .string()
...
export async function updateSalary(
  ...
  const response = await fetch(
    process.env.NEXT_PUBLIC_CHANGE_SALARY_ENDPOINT!,
    {
      method: "POST",
      headers: {
  ...
  if (!response.ok) {
    ...
    throw new Error(errorDetails.error || "Failed to update salary.");
  }
