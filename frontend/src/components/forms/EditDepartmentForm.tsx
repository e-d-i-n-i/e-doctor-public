...
const formSchema = z.object({
  userid: z.string(),
  new_department: z.enum(["Management", "Medical"]),
  current_password: z
    .string()
...
export default function EditDepartmentForm({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      userid: userid,
      new_department: "Management", // Default value
      current_password: "",
    },
  });
...
export async function updateDepartment(
  ...
  const response = await fetch(
    process.env.NEXT_PUBLIC_CHANGE_DEPARTMENT_ENDPOINT!,
    {
      method: "POST",
      headers: {
  ...
  if (!response.ok) {
    ...
    throw new Error(errorDetails.error || "Failed to update department.");
  }
