  ...
  navTask: [
    {
      ...
      items: [
        {
          title: "Not Answered",
          url: "/patient/follow-up-questions/active",
        },
        {
          title: "Submitted",
          url: "/patient/follow-up-questions/submitted",
        },
      ],
    },
  ],
  ...
  return (
    <Sidebar collapsible="icon" variant="floating" {...props}>
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs">Patient Account</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
      ...
      <SidebarContent>
        ...
        {isMobile && (
          <DialogTitle>
            <VisuallyHidden>Patient Sidebar</VisuallyHidden>
          </DialogTitle>
        )}
