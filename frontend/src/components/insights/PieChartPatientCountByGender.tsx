...
interface PieChartPatientCountByGenderProps {
...
export function PieChartPatientCountByGender({
  apiEndpoint,
}: PieChartPatientCountByGenderProps) {
  ...
  // Transform the data to match the PieChart format
  const pieChartData = [
    {
      name: "Female",
      value: data[0]?.female || 0,
      fill: "var(--color-female)",
    },
    { name: "Male", value: data[0]?.male || 0, fill: "var(--color-male)" },
  ];
